<?php
  ...
  class Clientes extends Conectar{
    ...
    public function agregar_cliente(){
    	...
    	if(empty($_POST["DUI"]) or empty($_POST["nombre"]) or empty($_POST["apellido"]) or empty($_POST["apodo"]) or empty($_POST["telefono"]) or empty($_POST["direccion"])){
    ...
    if(empty($_POST["dui_cliente"])  or empty($_POST["nom_cliente"]) or empty($_POST["ape_cliente"]) or empty($_POST["apodo_cliente"]) or empty($_POST["tlf_cliente"]) or empty($_POST["direc_cliente"])){
    ...
    $sql="select * from clientes where dui_cliente=? and nom_cliente=?;";

    $sql=$conectar->prepare($sql);

    $sql->bindValue(1,$_POST["dui_cliente"]);
    ...
    values(null,?,?,?,?,?,?,now());
     ...
     $sql2->bindValue(1,$_POST["dui_cliente"]);
     $sql2->bindValue(2,$_POST["nom_cliente"]);
     $sql2->bindValue(3,$_POST["ape_cliente"]);
     $sql2->bindValue(4,$_POST["apodo_cliente"]);
     $sql2->bindValue(5,$_POST["tlf_cliente"]);
     $sql2->bindValue(6,$_POST["direc_cliente"]);
     $sql2->execute();
