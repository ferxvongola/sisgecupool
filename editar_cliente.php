				...
				<div class="col-sm-8">
					...
					<div class="panel panel-default">
						 ...
						 <div class="panel-body">
							...
							<div class="col-sm-6">
								<input type="text" name="DUI" class="form-control" placeholder="ingrese su DUI" value="<?php echo $datos[0]["dui_cliente"];?>">
							</div>
							</div>	
                           ...
                           <div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="apodo" class="form-control" placeholder="ingrese su Apodo" value="<?php echo $datos[0]["apodo_cliente"];?>">
							</div>
							</div>
