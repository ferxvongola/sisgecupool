				...
				<div class="col-sm-8">
					...
					<?php
                       ...
                       if(isset($_GET["m"])){
                         ...
                         switch($_GET["m"]){
                           ...
                           case "2";
                           ?>
                           <h2>Cliente se registrado con Exito</h2>
                           <?php
                           break;
                         }
                       }
					...
					<div class="panel panel-default">
						 ...
						 <div class="panel-heading">
							...
							<div class="col-sm-6">
							<input type="text" name="DUI" class="form-control" data-mask="00000000-0" placeholder="Ingrese el DUI del cliente">
							</div>
							</div>
						   ...
						   <div class="form-group">
							...
							<input type="text" name="nombre" class="form-control" placeholder="Ingrese el nombre del cliente">
               				...
               				<div class="col-sm-6">
                 			<input type="text" name="apellido" class="form-control" placeholder="Ingrese el apellido del cliente">
               				</div>
                 			</div>

              				 <div class="form-group">
							<label for="" class="col-sm-2 control-label">Apodo</label>
							<div class="col-sm-6">
								<input type="text" name="apodo" class="form-control" placeholder="Ingrese el apodo del cliente">
							</div>
						    </div>
							...
							<div class="col-sm-6">
								<input type="text" name="telefono" class="form-control" data-mask="0000-0000" placeholder="Ingrese el telefono del cliente">
							</div>
							</div>
