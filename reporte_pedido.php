...
<tr>
<td width="54%" height="111"><h1 style="text-align: left; margin-right:20px;"><img src="public/images/masterPool.jpg" width="220" height="120"  /></h1></td>
<td width="46%"><table style="width: 100%; font-size: 8pt;">
  <tr>
    <td><strong>NIT: </strong> <?php echo $datos_empresa[0]["rif_empresa"]; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><strong>NIT/DUI: </strong><?php echo $_SESSION["cedula"]; ?></td>
  </tr>
  <tr>
