...
<th width="8%" bgcolor="#317eac"><span class="Estilo11">No DUI</span></th>
...
<th width="15%" bgcolor="#317eac"><span class="Estilo11">APODO</span></th>
...
<td><div align="center"><span class="Estilo3"><?php echo $datos[$i]['dui_cliente']; ?></span></div></td>
...
<td style="text-align: center"><div align="center"><span><?php echo $datos[$i]['apodo_cliente']; ?></span></div></td>
